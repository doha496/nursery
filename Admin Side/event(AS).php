...
<body>
<header>
    <img src="logo.png" id="logo" onclick="location.href='index(AS).html';">
    <h1 id="h1W">Events</h1>
    ...
    <div id="navMenu" >
        <div id="myTopnav" class="topnav">
            <a href="index(AS).html" id="admAdr">Home</a>
            <a href="acceptteacher(AS).html" id="admAdr">Teacher Acceptance</a>
            <a href="Addusers(AS).html" id="admAdr">Child Acceptance</a>
            <a href="editchild(AS).html" id="admAdr">Child Edit</a>
            <a href="editteacher(AS).html" id="admAdr">Teacher Edit</a>
            <div class="dropdown">
                <button class="dropbtn">More
                    <i class="fa fa-caret-down"></i>
                </button>
                <div class="dropdown-content">
                    <a href="EditDB.html" id="admAdr">Control Panel</a>
<!--                    <a id="admAdr" href="event(AS).html">Events</a>-->
                    <a id="admAdr" href="Schedules(AS).html">Schedule</a>
                    <a id="admADR" href="Payment(AS).html">Payments</a>
                    <a href="logout.html" id="admAdr">Logout</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="editEvents">
    <form action="afterCruds.html" method="post">
        <u id="A_E">Events List:</u> <br>
        <?php
        require_once("eventsController.html");
        $event = new eventsC();
