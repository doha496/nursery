...
<head>
  ...
  <header id="bkbtn">
    ...
    <p id="h1Ot">Teacher</p><p id="h1At">Application</p>
    ...
    <div id="navMenu" >
      <div id="myTopnav" class="topnav">
          ...
          <a id="addr" href="Schedules(US).html">Schedule</a>
...
<body>
    <div class = "teacher1">
        <form method="POST" action="MainController.html">
            ...
            <select name="qualification_id1" >
                ...
                <?php require_once("qualificationClass.html");
            ...
            <input type="Date" name="date_qual3"><br><br><hr>
