...
<body>
	...
	<header>
		<img src="logo.png" id="logo" onclick="location.href='index(US).html';">
		<p id="h1O">Online</p><p id="h1oA">Application</p>
		...
		<div id="navMenu" required>
            <div id="myTopnav" class="topnav">
                <a id="addr" href="index(US).html">Home</a>
<!--                <a id="addr" href="Onlineapplication(US).html">Online Application</a>-->
                 <a id="addr" href="addteacher(US).html">Teacher Registration</a>
                <a id="addr" href="Schedules(US).html">Schedules</a>
                <!-- <a id="addr" href="" required>Gallery</a>-->
                <a id="addr" href="events(US).html">Events</a>
                <div class="dropdown">
                    <button class="dropbtn">More
                        <i class="fa fa-caret-down"></i>
                    </button>
                    <div class="dropdown-content">
                       <a id="addr" href="adminlogin.html">Login</a>
                    </div>
                </div>
            </div>
         </div>
	...
	<div class = "Oappform">
        ...
        <form name="app" method="POST" action="MainController.html">
            Child's name:
            ...
            <select name="address_id" required>
                <?php require_once("AddressClass.html");
                    $addOBJ3 = new Address();
...
<!--                <option value="-1"></option>-->
                <?php require_once("BranchClass.html");
                $BOBJ3 = new branch();
            ...
            <hr>
            <u><h2 align="left" id="oat">Rules and Regulations</h2></u>
            <ol>
		...
		<div class = "application">
			...
			<h1 align="center" id="oat"> Registration Paper </h1>
			<ul align="left">
